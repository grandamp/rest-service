...
public class ValidateController {
	...
	ResponseEntity<V1VSSResponse> validatev1(@RequestBody V1VSSRequest request, @RequestHeader Map<String, String> headers) {
		...
		List<V1ResultByCertificate> resultsByCertificateList = new ArrayList<V1ResultByCertificate>();
		for (JsonX509Certificate toValidate: batchCerts) {
			...
			if (res instanceof Success) {
				...
				List<V1WantBack> wantBackResultList = new ArrayList<V1WantBack>();
				/*
				 * Check wantBack, and add CertPath if requested
				 */
				if (true == certPathWantBack) {
				...
				List<V1InvalidityReason> reasonList = new ArrayList<V1InvalidityReason>();
