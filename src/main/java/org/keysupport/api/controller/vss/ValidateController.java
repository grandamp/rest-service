...
@RestController
@Tag(name = "validate", description = "Validate a certificate")
public class ValidateController {
	...
	@io.swagger.v3.oas.annotations.parameters.RequestBody(description = "Details of the Item to be created", required = true, content = @Content(schema = @Schema(implementation = VssRequest.class), mediaType = MediaType.APPLICATION_JSON_VALUE, examples = {
			@ExampleObject(name = "A valid certificate request", value = "{\n"
					+ "  \"validationPolicy\": \"2.16.840.1.101.10.2.18.2.1.5\",\n"
					...
					+ "}"),
			@ExampleObject(name = "A revoked certificate request", value = "{\n"
					+ "  \"validationPolicy\": \"2.16.840.1.101.10.2.18.2.1.5\",\n"
