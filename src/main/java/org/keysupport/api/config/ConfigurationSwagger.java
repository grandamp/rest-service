...
public class ConfigurationSwagger {
	...
	public OpenAPI springShopOpenAPI() {
		return new OpenAPI()
				...
				.info(new Info()
						.title("Certificate Validation Service API")
						.description("Spring Boot reference implementation of the Certificate Validation Service API")
						.contact(new Contact()
			                    .name("Todd E. Johnson")
			                    .email("grandamp@gmail.com")
